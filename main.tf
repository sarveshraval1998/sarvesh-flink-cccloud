...
resource "confluent_kafka_topic" "source_topic" {
  ...
  credentials {
    key    = "XZCFIK25QWALKWAA"
    secret = "DLpoRDak6PRGkfGyhr9hm+MbV3uQtyqBUa7QjVQCfaS9Jx95lzaEl+7dVbe/Cz6u"
  }
}
...
resource "confluent_flink_statement" "my_flink_statement" {
  ...
  credentials {    
    key    = "OBOJEFVOWLMHCVCX"
    secret = "qxtRKcK3p3qDps12KtLWK90eVoVw1sDufcEj8r36xYE9IWjlXjAnOFlEuvA6wded"
  }
}
